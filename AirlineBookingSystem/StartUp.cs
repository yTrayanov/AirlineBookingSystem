...
namespace AirlineBookingSystem
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            systemManager.CreateFlight("HAHAHA", "BBB", "CCC", 2050, 13, 31, "1111");
            systemManager.CreateFlight("HAHAHA", "BBB", "CCC", 2050, 12, 33, "1111");
            ...
            systemManager.CreateFlight("DELTA", "BBB", "BBB", 2050, 12, 31, "1114");
